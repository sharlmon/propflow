        ...
        {query.isLoading ? (
          ...
          <>
            <dl className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              ...
              />
              <Metric label="Total units" value={query.data.metrics.total_units} to="/landlord/properties" />
              <Metric
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-2">
              <article className="rounded-2xl border bg-white p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Link className="text-sm font-semibold text-blue-700" to="/landlord/inquiries">
                    View all
                  </Link>
                </div>
              ...
              <article className="rounded-2xl border bg-white p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Link className="text-sm font-semibold text-blue-700" to="/landlord/payments">
                    View ledger
                  </Link>
                </div>
        ...
        {query.isLoading ? (
          ...
          <>
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-3">
              <Link to="/renter/inquiries" className="rounded-2xl border bg-white p-5">
              ...
              <Link to="/renter/maintenance" className="rounded-2xl border bg-white p-5">
