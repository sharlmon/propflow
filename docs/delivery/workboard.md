...
| `chore/demo-deployment` | Wednesday demo | Production build | Image/health config | Deterministic seed | Regression/demo script | CI | Complete locally; external hosting unconfigured |
