...
import { Download, Search, Filter, Calendar, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
import { Role } from '../enums';
import type { User } from '../types';

export const Leases: React.FC<{ user: User }> = ({ user }) => {
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                ...
                <button className="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-bold text-sm shadow-md">Create New Lease</button>
            </div>
            ...
            <div className="bg-white rounded-[32px] p-8 text-center border border-dashed border-slate-300">
                ...
                <p className="text-slate-500 max-w-sm mx-auto mb-6">Start by generating a lease for a tenant using our AI-powered legal assistant.</p>
