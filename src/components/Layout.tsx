...
const PropFlowLogo = () => (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M10 22V14L18 8L26 14V22" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                <header className="hidden md:flex items-center justify-between px-8 py-4 bg-white border-b shadow-sm z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <span className={`ml-2 px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest ${user.role === Role.LANDLORD ? 'bg-indigo-100 text-indigo-700' : 'bg-emerald-100 text-emerald-700'}`}>
                            {user.role} Portal
                        </span>
                    </div>
