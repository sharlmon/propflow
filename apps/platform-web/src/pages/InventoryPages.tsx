              ...
              <article key={property.id} className="rounded-2xl border bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    to={`/propflow/properties/${property.id}`}
                  >
...
export function NewPropertyPage() {
  ...
  async function submit(values: PropertyValues) {
    ...
    try {
      ...
      navigate(`/propflow/properties/${created.id}`);
    } catch (error) {
  ...
  return (
    <section>
      <Link to="/propflow/properties" className="text-sm font-semibold text-blue-700">
        ← Properties
      </Link>
